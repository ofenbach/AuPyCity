...
class DenoiserUI:
    ...
    def open(self):
        ...
        self.image_applyall = ImageTk.PhotoImage(Image.open("windows/assets/apply_all.png").resize((126, 29)))
        ...
        self.image_apply = ImageTk.PhotoImage(Image.open("windows/assets/apply.png").resize((126, 29)))
