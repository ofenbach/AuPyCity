...
from ui import bottom_bar
import ui.top_bar
import ui.work_frame
from audio.track import MonoTrack
...
class MainUI:
    ...
    def __init__(self, context):
        ...
        while True:
            ...
            # DRAW DEFAULT UI
            if first_time:
                self.TOP_BAR = ui.top_bar.TopBarUI(self.window, self.canvas, self.context)
                self.WORK_FRAME = ui.work_frame.WorkFrame(self.window, self.canvas, self.context)
